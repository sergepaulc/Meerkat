...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Risk.release'
        db.delete_column('devproc_risk', 'release_id')


    def backwards(self, orm):
        # Adding field 'Risk.approval_status'
        db.add_column('devproc_risk', 'approval_status',
                      self.gf('django.db.models.fields.CharField')(default=-1, max_length=128),
                      keep_default=False)

        # Adding field 'Risk.release'
        db.add_column('devproc_risk', 'release',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Release'], null=True, blank=True),
                      keep_default=False)
