...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devproc_responsibility', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('responsibility', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal('devproc', ['Responsibility'])
        ...
        # Changing field 'Customer.location'
        db.alter_column('devproc_customer', 'location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Deleting model 'Responsibility'
        db.delete_table('devproc_responsibility')
        ...
        # Changing field 'Customer.location'
        db.alter_column('devproc_customer', 'location', self.gf('django.db.models.fields.CharField')(default=-1, max_length=200))
