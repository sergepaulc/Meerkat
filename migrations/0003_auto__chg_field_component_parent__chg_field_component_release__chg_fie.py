...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Component.parent'
        db.alter_column('devproc_component', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Component'], null=True))

        # Changing field 'Component.release'
        db.alter_column('devproc_component', 'release_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Release'], null=True))

        # Changing field 'Component.attributes'
        db.alter_column('devproc_component', 'attributes_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Attribute'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Component.parent'
        db.alter_column('devproc_component', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['devproc.Component']))

        # Changing field 'Component.release'
        db.alter_column('devproc_component', 'release_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['devproc.Release']))

        # Changing field 'Component.attributes'
        db.alter_column('devproc_component', 'attributes_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['devproc.Attribute']))
