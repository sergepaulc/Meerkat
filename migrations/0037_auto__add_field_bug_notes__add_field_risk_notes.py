...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bug.notes'
        db.add_column('devproc_bug', 'notes',
                      self.gf('django.db.models.fields.TextField')(max_length=1028, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.notes'
        db.add_column('devproc_risk', 'notes',
                      self.gf('django.db.models.fields.TextField')(max_length=1028, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bug.notes'
        db.delete_column('devproc_bug', 'notes')

        # Deleting field 'Risk.notes'
        db.delete_column('devproc_risk', 'notes')
    ...
    models = {
        ...
        'devproc.company': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'default': "'default_company_logo.png'", 'max_length': '100'}),
        ...
        'devproc.release': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devproc.Product']"}),
            'product_manager': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'product_manager'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['devproc.Member']"}),
            'release_date': ('django.db.models.fields.DateTimeField', [], {}),
            'responsible_engineer': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'responsible_engineer'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['devproc.Member']"})
        },
        'devproc.requirement': {
        ...
        'devproc.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_manager': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'photo': ('django.db.models.fields.files.FileField', [], {'default': "'default_profile_photo.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['devproc.Team']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
