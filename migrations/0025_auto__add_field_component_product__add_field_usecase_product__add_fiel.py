...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Component.product'
        db.add_column('devproc_component', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devproc.Product']),
                      keep_default=False)

        # Adding field 'UseCase.product'
        db.add_column('devproc_usecase', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devproc.Product']),
                      keep_default=False)

        # Adding field 'Requirement.product'
        db.add_column('devproc_requirement', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devproc.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Component.product'
        db.delete_column('devproc_component', 'product_id')

        # Deleting field 'UseCase.product'
        db.delete_column('devproc_usecase', 'product_id')

        # Deleting field 'Requirement.product'
        db.delete_column('devproc_requirement', 'product_id')
