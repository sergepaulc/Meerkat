...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devproc_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=1028)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Company'])),
        ))
        db.send_create_signal('devproc', ['Product'])


    def backwards(self, orm):
        # Deleting model 'Product'
        db.delete_table('devproc_product')
