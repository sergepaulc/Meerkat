...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field product_manager on 'Release'
        m2m_table_name = db.shorten_name('devproc_release_product_manager')
        ...
        db.create_unique(m2m_table_name, ['release_id', 'member_id'])


    def backwards(self, orm):
        # Removing M2M table for field product_manager on 'Release'
        db.delete_table(db.shorten_name('devproc_release_product_manager'))
