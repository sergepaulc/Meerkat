...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Risk.feature'
        db.alter_column('devproc_risk', 'feature_id', self.gf('django.db.models.fields.related.ForeignKey')(default=11, to=orm['devproc.Feature']))

    def backwards(self, orm):

        # Changing field 'Risk.feature'
        db.alter_column('devproc_risk', 'feature_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Feature'], null=True))
