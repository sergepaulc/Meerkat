...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devproc_company', 'logo',
                      self.gf('django.db.models.fields.files.FileField')(default='default_company_logo.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.logo'
        db.delete_column('devproc_company', 'logo')
    ...
    models = {
        ...
        'devproc.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_manager': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'photo': ('django.db.models.fields.files.FileField', [], {'default': "'default_profile_photo.png'", 'max_length': '100'}),
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['devproc.Team']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
