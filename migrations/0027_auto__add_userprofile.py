...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devproc_userprofile', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Company'])),
        ))
        db.send_create_signal('devproc', ['UserProfile'])

        # Adding M2M table for field team on 'UserProfile'
        m2m_table_name = db.shorten_name('devproc_userprofile_team')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['devproc.userprofile'], null=False)),
            ('team', models.ForeignKey(orm['devproc.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'team_id'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('devproc_userprofile')

        # Removing M2M table for field team on 'UserProfile'
        db.delete_table(db.shorten_name('devproc_userprofile_team'))
