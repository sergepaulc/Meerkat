...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Release.roadmap'
        db.delete_column('devproc_release', 'roadmap_id')

        # Adding field 'Release.goals'
        db.add_column('devproc_release', 'goals', self.gf('django.db.models.fields.CharField')(max_length=1028, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('devproc_roadmap', (
            ...
            ('market', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        ...
        # Adding field 'Release.roadmap'
        db.add_column('devproc_release', 'roadmap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Roadmap'], null=True, blank=True), keep_default=False)

        # Deleting field 'Release.goals'
        db.delete_column('devproc_release', 'goals')
