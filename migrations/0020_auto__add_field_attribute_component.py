...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attribute.component'
        db.add_column('devproc_attribute', 'component', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devproc.Component']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Attribute.component'
        db.delete_column('devproc_attribute', 'component_id')
