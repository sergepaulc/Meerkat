...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Component.attributes'
        db.delete_column('devproc_component', 'attributes_id')

        # Adding M2M table for field attributes on 'Component'
        db.create_table('devproc_component_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('component', models.ForeignKey(orm['devproc.component'], null=False)),
            ('attribute', models.ForeignKey(orm['devproc.attribute'], null=False))
        ))
        db.create_unique('devproc_component_attributes', ['component_id', 'attribute_id'])


    def backwards(self, orm):
        
        # Adding field 'Component.attributes'
        db.add_column('devproc_component', 'attributes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Attribute'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field attributes on 'Component'
        db.delete_table('devproc_component_attributes')
