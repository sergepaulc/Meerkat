...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field responsible_engineer on 'Requirement'
        m2m_table_name = db.shorten_name('devproc_requirement_responsible_engineer')
        ...
        db.create_unique(m2m_table_name, ['requirement_id', 'member_id'])


    def backwards(self, orm):
        # Removing M2M table for field responsible_engineer on 'Requirement'
        db.delete_table(db.shorten_name('devproc_requirement_responsible_engineer'))
