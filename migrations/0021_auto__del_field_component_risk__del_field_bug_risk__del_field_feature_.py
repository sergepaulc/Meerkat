...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Risk.feature'
        db.add_column('devproc_risk', 'feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Feature'], null=True, blank=True), keep_default=False)

        # Adding field 'Risk.bug'
        db.add_column('devproc_risk', 'bug', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Bug'], null=True, blank=True), keep_default=False)

        # Adding field 'Risk.component'
        db.add_column('devproc_risk', 'component', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Component'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Risk.feature'
        db.delete_column('devproc_risk', 'feature_id')

        # Deleting field 'Risk.bug'
        db.delete_column('devproc_risk', 'bug_id')

        # Deleting field 'Risk.component'
        db.delete_column('devproc_risk', 'component_id')
