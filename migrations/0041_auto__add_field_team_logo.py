...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devproc_team', 'logo',
                      self.gf('django.db.models.fields.files.FileField')(default='default_team_logo.png', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.logo'
        db.delete_column('devproc_team', 'logo')
    ...
    models = {
        ...
        'devproc.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'default': "'default_team_logo.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
