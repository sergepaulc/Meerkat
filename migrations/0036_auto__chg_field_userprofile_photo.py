...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('devproc_userprofile', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.photo'
        db.alter_column('devproc_userprofile', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100))
