...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UseCase.release'
        db.delete_column('devproc_usecase', 'release_id')

        # Deleting field 'UseCase.target_user'
        db.delete_column('devproc_usecase', 'target_user')

        # Adding field 'UseCase.identifier'
        db.add_column('devproc_usecase', 'identifier', self.gf('django.db.models.fields.CharField')(default=-1, max_length=200), keep_default=False)

        # Adding field 'UseCase.source'
        db.add_column('devproc_usecase', 'source', self.gf('django.db.models.fields.CharField')(default=-1, max_length=128), keep_default=False)

        # Adding field 'UseCase.notes'
        db.add_column('devproc_usecase', 'notes', self.gf('django.db.models.fields.TextField')(max_length=1028, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UseCase.release'
        db.add_column('devproc_usecase', 'release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devproc.Release'], null=True, blank=True), keep_default=False)

        # Adding field 'UseCase.target_user'
        db.add_column('devproc_usecase', 'target_user', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'UseCase.identifier'
        db.delete_column('devproc_usecase', 'identifier')

        # Deleting field 'UseCase.source'
        db.delete_column('devproc_usecase', 'source')

        # Deleting field 'UseCase.notes'
        db.delete_column('devproc_usecase', 'notes')
    ...
    models = {
        ...
        'devproc.feature': {
            ...
            'responsible_engineer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['devproc.Member']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'usecase': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devproc.UseCase']", 'null': 'True', 'blank': 'True'})
        },
        'devproc.member': {
